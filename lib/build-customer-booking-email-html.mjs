...
<tr>
<td style="background-color:${BORDER};padding:28px 24px 22px 24px;text-align:center;border-bottom:1px solid #2a2a2a;">
...
<!-- CTA (centred) -->
<tr>
<td align="center" style="padding:12px 28px 32px 28px;text-align:center;">
...
<tr>
<td align="center" style="background-color:${CTA_RED};border-radius:5px;padding:0;">
